...
***********************************************************************
      ...
      rnuc5 = rnuc * 1.0d-15/0.529177249d-10 
      write (*,15) inuc,rnuc,rnuc5
15    format ('inuc =',i3,'  rnuc =',f7.4,'fm  rnuc = ',f10.6)
      rewind 1
      close(unit=1)
 901  stop
      end
...
****************************************************************
*
*     Select orbial with largest error and solve DHF equations
* 
****************************************************************
